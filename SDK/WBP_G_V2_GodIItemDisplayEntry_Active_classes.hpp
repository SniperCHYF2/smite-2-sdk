...
// WidgetBlueprintGeneratedClass WBP_G_V2_GodIItemDisplayEntry_Active.WBP_G_V2_GodIItemDisplayEntry_Active_C
// 0x0118 (0x0860 - 0x0748)
class UWBP_G_V2_GodIItemDisplayEntry_Active_C final : public UHWActivatableEquipmentWidget
{
public:
...
public:
	...
	void ExecuteUbergraph_WBP_G_V2_GodIItemDisplayEntry_Active(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_G_V2_GodIItemDisplayEntry_Active_C">();
	}
	static class UWBP_G_V2_GodIItemDisplayEntry_Active_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_G_V2_GodIItemDisplayEntry_Active_C>();
	}
};
static_assert(alignof(UWBP_G_V2_GodIItemDisplayEntry_Active_C) == 0x000008, "Wrong alignment on UWBP_G_V2_GodIItemDisplayEntry_Active_C");
static_assert(sizeof(UWBP_G_V2_GodIItemDisplayEntry_Active_C) == 0x000860, "Wrong size on UWBP_G_V2_GodIItemDisplayEntry_Active_C");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, UberGraphFrame) == 0x000748, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, CooldownCompleteAnim) == 0x000750, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::CooldownCompleteAnim' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, ActiveSheen) == 0x000758, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::ActiveSheen' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, PersistentFiredAnim) == 0x000760, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::PersistentFiredAnim' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, AimingPhaseAnim) == 0x000768, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::AimingPhaseAnim' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, FiredPhaseAnim) == 0x000770, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::FiredPhaseAnim' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, PreFirePhaseAnim) == 0x000778, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::PreFirePhaseAnim' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, AimingScaler) == 0x000780, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::AimingScaler' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, AmmoText) == 0x000788, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::AmmoText' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, AmmoWrapper) == 0x000790, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::AmmoWrapper' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, CooldownDarken) == 0x000798, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::CooldownDarken' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, CooldownPulse) == 0x0007A0, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::CooldownPulse' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, EquipmentFrame) == 0x0007A8, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::EquipmentFrame' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, FiredFlashOverlay) == 0x0007B0, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::FiredFlashOverlay' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, HitArea_Border) == 0x0007B8, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::HitArea_Border' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, HitArea_Gamepad) == 0x0007C0, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::HitArea_Gamepad' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, HitAreaWidgetSwitcher) == 0x0007C8, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::HitAreaWidgetSwitcher' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, Hotkeys) == 0x0007D0, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::Hotkeys' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, HoverBG) == 0x0007D8, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::HoverBG' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, ItemIcon) == 0x0007E0, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::ItemIcon' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, PhaseSwitcher) == 0x0007E8, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::PhaseSwitcher' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, PreFireOverlay) == 0x0007F0, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::PreFireOverlay' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, StackOverlay) == 0x0007F8, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::StackOverlay' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, StackText) == 0x000800, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::StackText' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, ItemIconMaterial) == 0x000808, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::ItemIconMaterial' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, ValueCount) == 0x000810, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::ValueCount' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, ValueMaxed) == 0x000814, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::ValueMaxed' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, CurrentTextureIcon) == 0x000818, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::CurrentTextureIcon' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, Equipment_Info) == 0x000840, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::Equipment_Info' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, SFXInventoryHover) == 0x000848, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::SFXInventoryHover' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, SFXInventoryDragStart) == 0x000850, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::SFXInventoryDragStart' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_GodIItemDisplayEntry_Active_C, SFXInventoryDragEnd) == 0x000858, "Member 'UWBP_G_V2_GodIItemDisplayEntry_Active_C::SFXInventoryDragEnd' has a wrong offset!");
