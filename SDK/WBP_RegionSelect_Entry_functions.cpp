...
bool UWBP_RegionSelect_Entry_C::IsCustomLobbyRegionSelect()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_RegionSelect_Entry_C", "IsCustomLobbyRegionSelect");

	Params::WBP_RegionSelect_Entry_C_IsCustomLobbyRegionSelect Parms{};
...
void UWBP_RegionSelect_Entry_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::WBP_RegionSelect_Entry_C_PreConstruct Parms{};
