...
// Function WBP_Social_Search_bar.WBP_Social_Search_bar_C.PlayHoverSFX
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_Social_Search_bar_C::PlayHoverSFX()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Social_Search_bar_C", "PlayHoverSFX");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WBP_Social_Search_bar.WBP_Social_Search_bar_C.PlayClickSFX
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_Social_Search_bar_C::PlayClickSFX()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Social_Search_bar_C", "PlayClickSFX");
...
void UWBP_Social_Search_bar_C::BndEvt__InputText_K2Node_ComponentBoundEvent_1_OnEditableTextBoxChangedEvent__DelegateSignature(const class FText& Text)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_Social_Search_bar_C_BndEvt__InputText_K2Node_ComponentBoundEvent_1_OnEditableTextBoxChangedEvent__DelegateSignature Parms{};
...
void UWBP_Social_Search_bar_C::BndEvt__InputText_K2Node_ComponentBoundEvent_0_OnEditableTextBoxCommittedEvent__DelegateSignature(const class FText& Text, ETextCommit CommitMethod)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_Social_Search_bar_C_BndEvt__InputText_K2Node_ComponentBoundEvent_0_OnEditableTextBoxCommittedEvent__DelegateSignature Parms{};
