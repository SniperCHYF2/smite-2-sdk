...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const struct FGameplayAbilitySpecHandle&AbilitySpec                                            (ConstParm, Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGameplayTagContainer UGameplayAbility::GetAbilityTags(const struct FGameplayAbilitySpecHandle& AbilitySpec, const class UAbilitySystemComponent* AbilitySystem) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameplayAbility", "GetAbilityTags");

	Params::GameplayAbility_GetAbilityTags Parms{};
...
void UAbilityTask_WaitTargetData::OnTargetDataReplicatedCancelledCallback(const struct FGameplayAbilityTargetDataHandle& Data, const struct FGameplayTag& ActivationTag)
{
	static class UFunction* Func = nullptr;
	...
	Params::AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback Parms{};
...
// uint8*                                  GameplayStackCount                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UAbilitySystemBlueprintLibrary::BreakGameplayCueParameters(const struct FGameplayCueParameters& Parameters, float* NormalizedMagnitude, float* RawMagnitude, struct FGameplayEffectContextHandle* EffectContext, struct FGameplayTag* MatchedTagName, struct FGameplayTag* OriginalTag, struct FGameplayTagContainer* AggregatedSourceTags, struct FGameplayTagContainer* AggregatedTargetTags, struct FVector* Location, struct FVector* Normal, class AActor** Instigator, class AActor** EffectCauser, class UObject** SourceObject, class UPhysicalMaterial** PhysicalMaterial, int32* GameplayEffectLevel, int32* AbilityLevel, uint8* GameplayStackCount, class USceneComponent** TargetAttachComponent, bool* bReplicateLocationWhenUsingMinimalRepProxy)
{
	...
	if (GameplayStackCount != nullptr)
		*GameplayStackCount = Parms.GameplayStackCount;
...
TArray<struct FHitResult> UAbilitySystemBlueprintLibrary::GetAllHitResultsFromTargetData(const struct FGameplayAbilityTargetDataHandle& TargetData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AbilitySystemBlueprintLibrary", "GetAllHitResultsFromTargetData");

	Params::AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData Parms{};
...
// uint8                                   GameplayStackCount                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGameplayCueParameters UAbilitySystemBlueprintLibrary::MakeGameplayCueParameters(float NormalizedMagnitude, float RawMagnitude, const struct FGameplayEffectContextHandle& EffectContext, const struct FGameplayTag& MatchedTagName, const struct FGameplayTag& OriginalTag, const struct FGameplayTagContainer& AggregatedSourceTags, const struct FGameplayTagContainer& AggregatedTargetTags, const struct FVector& Location, const struct FVector& Normal, class AActor* Instigator, class AActor* EffectCauser, class UObject* SourceObject, class UPhysicalMaterial* PhysicalMaterial, int32 GameplayEffectLevel, int32 AbilityLevel, uint8 GameplayStackCount, class USceneComponent* TargetAttachComponent, bool bReplicateLocationWhenUsingMinimalRepProxy)
{
	...
	Parms.GameplayStackCount = GameplayStackCount;
...
void UAbilitySystemComponent::ServerSetReplicatedTargetDataCancelled(const struct FGameplayAbilitySpecHandle& AbilityHandle, const struct FPredictionKey& AbilityOriginalPredictionKey, const struct FGameplayAbilityTargetDataHandle& ReplicatedTargetDataHandle, const struct FGameplayTag& ApplicationTag, const struct FPredictionKey& CurrentPredictionKey)
{
	static class UFunction* Func = nullptr;
...
class AActor* UAbilitySystemComponent::GetAvatarActor() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AbilitySystemComponent", "GetAvatarActor");

	Params::AbilitySystemComponent_GetAvatarActor Parms{};
...
class FName UAbilitySystemComponent::GetCurrentMontageSectionName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AbilitySystemComponent", "GetCurrentMontageSectionName");

	Params::AbilitySystemComponent_GetCurrentMontageSectionName Parms{};
...
class AActor* UAbilitySystemComponent::GetOwnerActor() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AbilitySystemComponent", "GetOwnerActor");

	Params::AbilitySystemComponent_GetOwnerActor Parms{};
