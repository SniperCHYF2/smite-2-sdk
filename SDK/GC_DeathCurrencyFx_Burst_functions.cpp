...
#include "GC_DeathCurrencyFx_Burst_classes.hpp"
#include "GC_DeathCurrencyFx_Burst_parameters.hpp"
...
void UGC_DeathCurrencyFx_Burst_C::OnBurst(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_DeathCurrencyFx_Burst_C", "OnBurst");

	Params::GC_DeathCurrencyFx_Burst_C_OnBurst Parms{};
