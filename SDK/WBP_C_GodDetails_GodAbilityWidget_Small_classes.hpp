...
// WidgetBlueprintGeneratedClass WBP_C_GodDetails_GodAbilityWidget_Small.WBP_C_GodDetails_GodAbilityWidget_Small_C
// 0x0058 (0x0680 - 0x0628)
class UWBP_C_GodDetails_GodAbilityWidget_Small_C final : public UHWGodAbilityEntryWidget
{
public:
...
public:
	...
	void ExecuteUbergraph_WBP_C_GodDetails_GodAbilityWidget_Small(int32 EntryPoint);
	void HandleOnPipClicked(int32 PipIndex);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_C_GodDetails_GodAbilityWidget_Small_C">();
	}
	static class UWBP_C_GodDetails_GodAbilityWidget_Small_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_C_GodDetails_GodAbilityWidget_Small_C>();
	}
};
static_assert(alignof(UWBP_C_GodDetails_GodAbilityWidget_Small_C) == 0x000008, "Wrong alignment on UWBP_C_GodDetails_GodAbilityWidget_Small_C");
static_assert(sizeof(UWBP_C_GodDetails_GodAbilityWidget_Small_C) == 0x000680, "Wrong size on UWBP_C_GodDetails_GodAbilityWidget_Small_C");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, UberGraphFrame) == 0x000628, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, AbilityIcon) == 0x000630, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::AbilityIcon' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, HitArea) == 0x000638, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::HitArea' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, Hover_Stroke) == 0x000640, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::Hover_Stroke' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, LoadingThrobber) == 0x000648, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::LoadingThrobber' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, Main_SizeBox) == 0x000650, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::Main_SizeBox' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, PipSet) == 0x000658, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::PipSet' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, Selected_Stroke) == 0x000660, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::Selected_Stroke' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, AbilityIconMaterial) == 0x000668, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::AbilityIconMaterial' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, SFXSelect) == 0x000670, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::SFXSelect' has a wrong offset!");
static_assert(offsetof(UWBP_C_GodDetails_GodAbilityWidget_Small_C, SFXHover) == 0x000678, "Member 'UWBP_C_GodDetails_GodAbilityWidget_Small_C::SFXHover' has a wrong offset!");
