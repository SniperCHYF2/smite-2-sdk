...
static_assert(alignof(IKantanCartesianDatasourceInterface) == 0x000001, "Wrong alignment on IKantanCartesianDatasourceInterface");
static_assert(sizeof(IKantanCartesianDatasourceInterface) == 0x000001, "Wrong size on IKantanCartesianDatasourceInterface");
...
static_assert(alignof(IKantanCategoryDatasourceInterface) == 0x000001, "Wrong alignment on IKantanCategoryDatasourceInterface");
static_assert(sizeof(IKantanCategoryDatasourceInterface) == 0x000001, "Wrong size on IKantanCategoryDatasourceInterface");
