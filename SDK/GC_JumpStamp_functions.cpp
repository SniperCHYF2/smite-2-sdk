...
#include "GC_JumpStamp_classes.hpp"
#include "GC_JumpStamp_parameters.hpp"
...
void UGC_JumpStamp_C::OnBurst(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_JumpStamp_C", "OnBurst");

	Params::GC_JumpStamp_C_OnBurst Parms{};
