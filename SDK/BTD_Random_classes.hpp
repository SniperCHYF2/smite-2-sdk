...
{
public:
	double                                        SuccessChance;                                     // 0x00A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UBTD_Random_C, SuccessChance) == 0x0000A0, "Member 'UBTD_Random_C::SuccessChance' has a wrong offset!");
