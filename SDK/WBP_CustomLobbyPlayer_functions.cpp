...
void UWBP_CustomLobbyPlayer_C::HandleSwitchTeams(bool bNext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CustomLobbyPlayer_C", "HandleSwitchTeams");

	Params::WBP_CustomLobbyPlayer_C_HandleSwitchTeams Parms{};
...
// Function WBP_CustomLobbyPlayer.WBP_CustomLobbyPlayer_C.InitializeWidget
// (Event, Public, BlueprintCallable, BlueprintEvent)

void UWBP_CustomLobbyPlayer_C::InitializeWidget()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CustomLobbyPlayer_C", "InitializeWidget");
...
// Parameters:
// const struct FHWCustomBotConfig_Single& botConfig                                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)

void UWBP_CustomLobbyPlayer_C::SetBot(const struct FHWCustomBotConfig_Single& botConfig)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CustomLobbyPlayer_C", "SetBot");

	Params::WBP_CustomLobbyPlayer_C_SetBot Parms{};
...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FRH_CustomMatchMember&     InMatchMember                                          (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
