...
class UWidget* UWBP_ButtonStacked_C::BP_GetDesiredFocusTarget() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ButtonStacked_C", "BP_GetDesiredFocusTarget");

	Params::WBP_ButtonStacked_C_BP_GetDesiredFocusTarget Parms{};
