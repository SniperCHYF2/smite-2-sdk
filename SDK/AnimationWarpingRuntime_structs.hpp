...
{
public:
	EWarpingEvaluationMode                        PlantSpeedMode;                                    // 0x00D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D1[0x3];                                       // 0x00D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBoneReference                         IKFootRootBone;                                    // 0x00D4(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBoneReference                         PelvisBone;                                        // 0x00E4(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FFootPlacementPelvisSettings           PelvisSettings;                                    // 0x00F4(0x001C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FFootPlacementInterpolationSettings    InterpolationSettings;                             // 0x0154(0x0024)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_194[0x27C];                                    // 0x0194(0x027C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_FootPlacement, PlantSpeedMode) == 0x0000D0, "Member 'FAnimNode_FootPlacement::PlantSpeedMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_FootPlacement, IKFootRootBone) == 0x0000D4, "Member 'FAnimNode_FootPlacement::IKFootRootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_FootPlacement, PelvisBone) == 0x0000E4, "Member 'FAnimNode_FootPlacement::PelvisBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_FootPlacement, PelvisSettings) == 0x0000F4, "Member 'FAnimNode_FootPlacement::PelvisSettings' has a wrong offset!");
...
{
public:
	EWarpingEvaluationMode                        Mode;                                              // 0x00D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D1[0x3];                                       // 0x00D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OrientationAngle;                                  // 0x00D4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LocomotionAngle;                                   // 0x00D8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinRootMotionSpeedThreshold;                       // 0x00DC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LocomotionAngleDeltaThreshold;                     // 0x00E0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E4[0x4];                                       // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FBoneReference>                 SpineBones;                                        // 0x00E8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FBoneReference                         IKFootRootBone;                                    // 0x00F8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FBoneReference>                 IKFootBones;                                       // 0x0108(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	EAxis                                         RotationAxis;                                      // 0x0118(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_119[0x3];                                      // 0x0119(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DistributedBoneOrientationAlpha;                   // 0x011C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RotationInterpSpeed;                               // 0x0120(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WarpingAlpha;                                      // 0x0124(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OffsetAlpha;                                       // 0x0128(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxOffsetAngle;                                    // 0x012C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_OrientationWarping, Mode) == 0x0000D0, "Member 'FAnimNode_OrientationWarping::Mode' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, OrientationAngle) == 0x0000D4, "Member 'FAnimNode_OrientationWarping::OrientationAngle' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, LocomotionAngle) == 0x0000D8, "Member 'FAnimNode_OrientationWarping::LocomotionAngle' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, MinRootMotionSpeedThreshold) == 0x0000DC, "Member 'FAnimNode_OrientationWarping::MinRootMotionSpeedThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, LocomotionAngleDeltaThreshold) == 0x0000E0, "Member 'FAnimNode_OrientationWarping::LocomotionAngleDeltaThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, SpineBones) == 0x0000E8, "Member 'FAnimNode_OrientationWarping::SpineBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, IKFootRootBone) == 0x0000F8, "Member 'FAnimNode_OrientationWarping::IKFootRootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, IKFootBones) == 0x000108, "Member 'FAnimNode_OrientationWarping::IKFootBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, RotationAxis) == 0x000118, "Member 'FAnimNode_OrientationWarping::RotationAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, DistributedBoneOrientationAlpha) == 0x00011C, "Member 'FAnimNode_OrientationWarping::DistributedBoneOrientationAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, RotationInterpSpeed) == 0x000120, "Member 'FAnimNode_OrientationWarping::RotationInterpSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, WarpingAlpha) == 0x000124, "Member 'FAnimNode_OrientationWarping::WarpingAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, OffsetAlpha) == 0x000128, "Member 'FAnimNode_OrientationWarping::OffsetAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, MaxOffsetAngle) == 0x00012C, "Member 'FAnimNode_OrientationWarping::MaxOffsetAngle' has a wrong offset!");
...
public:
	...
	struct FBoneReference                         PelvisBone;                                        // 0x00F8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FSlopeWarpingFootDefinition>    FeetDefinitions;                                   // 0x0108(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FSlopeWarpingFootData>          FeetData;                                          // 0x0118(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	struct FVectorRK4SpringInterpolator           PelvisOffsetInterpolator;                          // 0x0128(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_130[0x58];                                     // 0x0130(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                GravityDir;                                        // 0x0188(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CustomFloorOffset;                                 // 0x01A0(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CachedDeltaTime;                                   // 0x01B8(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                TargetFloorNormalWorldSpace;                       // 0x01C0(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVectorRK4SpringInterpolator           FloorNormalInterpolator;                           // 0x01D8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E0[0x58];                                     // 0x01E0(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                TargetFloorOffsetLocalSpace;                       // 0x0238(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVectorRK4SpringInterpolator           FloorOffsetInterpolator;                           // 0x0250(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_258[0x58];                                     // 0x0258(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxStepHeight;                                     // 0x02B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bKeepMeshInsideOfCapsule : 1;                      // 0x02B4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPullPelvisDown : 1;                               // 0x02B4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseCustomFloorOffset : 1;                         // 0x02B4(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bWasOnGround : 1;                                  // 0x02B4(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShowDebug : 1;                                    // 0x02B4(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bFloorSmoothingInitialized : 1;                    // 0x02B4(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2B5[0x3];                                      // 0x02B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                ActorLocation;                                     // 0x02B8(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                GravityDirCompSpace;                               // 0x02D0(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
static_assert(alignof(FAnimNode_SlopeWarping) == 0x000008, "Wrong alignment on FAnimNode_SlopeWarping");
static_assert(sizeof(FAnimNode_SlopeWarping) == 0x0002E8, "Wrong size on FAnimNode_SlopeWarping");
static_assert(offsetof(FAnimNode_SlopeWarping, IKFootRootBone) == 0x0000E8, "Member 'FAnimNode_SlopeWarping::IKFootRootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, PelvisBone) == 0x0000F8, "Member 'FAnimNode_SlopeWarping::PelvisBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, FeetDefinitions) == 0x000108, "Member 'FAnimNode_SlopeWarping::FeetDefinitions' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, FeetData) == 0x000118, "Member 'FAnimNode_SlopeWarping::FeetData' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, PelvisOffsetInterpolator) == 0x000128, "Member 'FAnimNode_SlopeWarping::PelvisOffsetInterpolator' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, GravityDir) == 0x000188, "Member 'FAnimNode_SlopeWarping::GravityDir' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, CustomFloorOffset) == 0x0001A0, "Member 'FAnimNode_SlopeWarping::CustomFloorOffset' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, CachedDeltaTime) == 0x0001B8, "Member 'FAnimNode_SlopeWarping::CachedDeltaTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, TargetFloorNormalWorldSpace) == 0x0001C0, "Member 'FAnimNode_SlopeWarping::TargetFloorNormalWorldSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, FloorNormalInterpolator) == 0x0001D8, "Member 'FAnimNode_SlopeWarping::FloorNormalInterpolator' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, TargetFloorOffsetLocalSpace) == 0x000238, "Member 'FAnimNode_SlopeWarping::TargetFloorOffsetLocalSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, FloorOffsetInterpolator) == 0x000250, "Member 'FAnimNode_SlopeWarping::FloorOffsetInterpolator' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, MaxStepHeight) == 0x0002B0, "Member 'FAnimNode_SlopeWarping::MaxStepHeight' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, ActorLocation) == 0x0002B8, "Member 'FAnimNode_SlopeWarping::ActorLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_SlopeWarping, GravityDirCompSpace) == 0x0002D0, "Member 'FAnimNode_SlopeWarping::GravityDirCompSpace' has a wrong offset!");
...
public:
	...
	struct FVector                                StrideDirection;                                   // 0x00D8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StrideScale;                                       // 0x00F0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LocomotionSpeed;                                   // 0x00F4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinRootMotionSpeedThreshold;                       // 0x00F8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBoneReference                         PelvisBone;                                        // 0x00FC(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBoneReference                         IKFootRootBone;                                    // 0x010C(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_11C[0x4];                                      // 0x011C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FStrideWarpingFootDefinition>   FootDefinitions;                                   // 0x0120(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FInputClampConstants                   StrideScaleModifier;                               // 0x0130(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_144[0x4];                                      // 0x0144(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FWarpingVectorValue                    FloorNormalDirection;                              // 0x0148(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FWarpingVectorValue                    GravityDirection;                                  // 0x0168(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FIKFootPelvisPullDownSolver            PelvisIKFootSolver;                                // 0x0188(0x0080)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bOrientStrideDirectionUsingFloorNormal;            // 0x0208(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCompensateIKUsingFKThighRotation;                 // 0x0209(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bClampIKUsingFKLimits;                             // 0x020A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_20B[0x45];                                     // 0x020B(0x0045)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_StrideWarping) == 0x000008, "Wrong alignment on FAnimNode_StrideWarping");
static_assert(sizeof(FAnimNode_StrideWarping) == 0x000250, "Wrong size on FAnimNode_StrideWarping");
static_assert(offsetof(FAnimNode_StrideWarping, Mode) == 0x0000D0, "Member 'FAnimNode_StrideWarping::Mode' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, StrideDirection) == 0x0000D8, "Member 'FAnimNode_StrideWarping::StrideDirection' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, StrideScale) == 0x0000F0, "Member 'FAnimNode_StrideWarping::StrideScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, LocomotionSpeed) == 0x0000F4, "Member 'FAnimNode_StrideWarping::LocomotionSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, MinRootMotionSpeedThreshold) == 0x0000F8, "Member 'FAnimNode_StrideWarping::MinRootMotionSpeedThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, PelvisBone) == 0x0000FC, "Member 'FAnimNode_StrideWarping::PelvisBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, IKFootRootBone) == 0x00010C, "Member 'FAnimNode_StrideWarping::IKFootRootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, FootDefinitions) == 0x000120, "Member 'FAnimNode_StrideWarping::FootDefinitions' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, StrideScaleModifier) == 0x000130, "Member 'FAnimNode_StrideWarping::StrideScaleModifier' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, FloorNormalDirection) == 0x000148, "Member 'FAnimNode_StrideWarping::FloorNormalDirection' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, GravityDirection) == 0x000168, "Member 'FAnimNode_StrideWarping::GravityDirection' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, PelvisIKFootSolver) == 0x000188, "Member 'FAnimNode_StrideWarping::PelvisIKFootSolver' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, bOrientStrideDirectionUsingFloorNormal) == 0x000208, "Member 'FAnimNode_StrideWarping::bOrientStrideDirectionUsingFloorNormal' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, bCompensateIKUsingFKThighRotation) == 0x000209, "Member 'FAnimNode_StrideWarping::bCompensateIKUsingFKThighRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, bClampIKUsingFKLimits) == 0x00020A, "Member 'FAnimNode_StrideWarping::bClampIKUsingFKLimits' has a wrong offset!");
