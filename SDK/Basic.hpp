...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0961B5A0;
	constexpr int32 AppendString      = 0x00D56F50;
	constexpr int32 GNames            = 0x09574B40;
	constexpr int32 GWorld            = 0x0978C268;
	constexpr int32 ProcessEvent      = 0x00F316C0;
