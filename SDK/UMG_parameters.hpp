...
// Function UMG.ScrollBox.SetConsumeAnalog
// 0x0001 (0x0001 - 0x0000)
struct ScrollBox_SetConsumeAnalog final
{
public:
	EConsumeAnalog                                NewConsumeAnalog;                                  // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ScrollBox_SetConsumeAnalog) == 0x000001, "Wrong alignment on ScrollBox_SetConsumeAnalog");
static_assert(sizeof(ScrollBox_SetConsumeAnalog) == 0x000001, "Wrong size on ScrollBox_SetConsumeAnalog");
static_assert(offsetof(ScrollBox_SetConsumeAnalog, NewConsumeAnalog) == 0x000000, "Member 'ScrollBox_SetConsumeAnalog::NewConsumeAnalog' has a wrong offset!");
