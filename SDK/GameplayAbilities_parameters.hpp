...
static_assert(sizeof(AbilityTask_WaitGameplayEffectApplied_OnApplyGameplayEffectCallback) == 0x0002B8, "Wrong size on AbilityTask_WaitGameplayEffectApplied_OnApplyGameplayEffectCallback");
...
static_assert(offsetof(AbilityTask_WaitGameplayEffectApplied_OnApplyGameplayEffectCallback, ActiveHandle) == 0x0002B0, "Member 'AbilityTask_WaitGameplayEffectApplied_OnApplyGameplayEffectCallback::ActiveHandle' has a wrong offset!");
...
// Function GameplayAbilities.GameplayAbility.GetAbilityTags
// 0x0030 (0x0030 - 0x0000)
struct GameplayAbility_GetAbilityTags final
{
public:
	struct FGameplayAbilitySpecHandle             AbilitySpec;                                       // 0x0000(0x0004)(ConstParm, Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	const class UAbilitySystemComponent*          AbilitySystem;                                     // 0x0008(0x0008)(ConstParm, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  ReturnValue;                                       // 0x0010(0x0020)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(GameplayAbility_GetAbilityTags) == 0x000008, "Wrong alignment on GameplayAbility_GetAbilityTags");
static_assert(sizeof(GameplayAbility_GetAbilityTags) == 0x000030, "Wrong size on GameplayAbility_GetAbilityTags");
static_assert(offsetof(GameplayAbility_GetAbilityTags, AbilitySpec) == 0x000000, "Member 'GameplayAbility_GetAbilityTags::AbilitySpec' has a wrong offset!");
static_assert(offsetof(GameplayAbility_GetAbilityTags, AbilitySystem) == 0x000008, "Member 'GameplayAbility_GetAbilityTags::AbilitySystem' has a wrong offset!");
static_assert(offsetof(GameplayAbility_GetAbilityTags, ReturnValue) == 0x000010, "Member 'GameplayAbility_GetAbilityTags::ReturnValue' has a wrong offset!");
...
// 0x0030 (0x0030 - 0x0000)
struct AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback final
{
public:
	struct FGameplayAbilityTargetDataHandle       Data;                                              // 0x0000(0x0028)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FGameplayTag                           ActivationTag;                                     // 0x0028(0x0008)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback) == 0x000008, "Wrong alignment on AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback");
static_assert(sizeof(AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback) == 0x000030, "Wrong size on AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback");
static_assert(offsetof(AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback, Data) == 0x000000, "Member 'AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback::Data' has a wrong offset!");
static_assert(offsetof(AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback, ActivationTag) == 0x000028, "Member 'AbilityTask_WaitTargetData_OnTargetDataReplicatedCancelledCallback::ActivationTag' has a wrong offset!");
...
public:
	...
	uint8                                         GameplayStackCount;                                // 0x01A0(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A1[0x7];                                      // 0x01A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USceneComponent*                        TargetAttachComponent;                             // 0x01A8(0x0008)(Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(AbilitySystemBlueprintLibrary_BreakGameplayCueParameters, GameplayStackCount) == 0x0001A0, "Member 'AbilitySystemBlueprintLibrary_BreakGameplayCueParameters::GameplayStackCount' has a wrong offset!");
...
// Function GameplayAbilities.AbilitySystemBlueprintLibrary.GetAllHitResultsFromTargetData
// 0x0038 (0x0038 - 0x0000)
struct AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData final
{
public:
	struct FGameplayAbilityTargetDataHandle       TargetData;                                        // 0x0000(0x0028)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
static_assert(alignof(AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData) == 0x000008, "Wrong alignment on AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData");
static_assert(sizeof(AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData) == 0x000038, "Wrong size on AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData");
static_assert(offsetof(AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData, TargetData) == 0x000000, "Member 'AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData::TargetData' has a wrong offset!");
static_assert(offsetof(AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData, ReturnValue) == 0x000028, "Member 'AbilitySystemBlueprintLibrary_GetAllHitResultsFromTargetData::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         GameplayStackCount;                                // 0x00C8(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FGameplayCueParameters                 ReturnValue;                                       // 0x00E0(0x00D8)(Parm, OutParm, ReturnParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(AbilitySystemBlueprintLibrary_MakeGameplayCueParameters, GameplayStackCount) == 0x0000C8, "Member 'AbilitySystemBlueprintLibrary_MakeGameplayCueParameters::GameplayStackCount' has a wrong offset!");
...
public:
	...
	struct FPredictionKey                         PredictionKey;                                     // 0x0080(0x0018)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AbilitySystemComponent_NetMulticast_InvokeGameplayCueAddedAndWhileActive_FromSpec) == 0x000098, "Wrong size on AbilitySystemComponent_NetMulticast_InvokeGameplayCueAddedAndWhileActive_FromSpec");
...
static_assert(sizeof(AbilitySystemComponent_NetMulticast_InvokeGameplayCueExecuted_FromSpec) == 0x000098, "Wrong size on AbilitySystemComponent_NetMulticast_InvokeGameplayCueExecuted_FromSpec");
...
static_assert(sizeof(AbilitySystemComponent_ServerSetReplicatedTargetDataCancelled) == 0x000068, "Wrong size on AbilitySystemComponent_ServerSetReplicatedTargetDataCancelled");
...
static_assert(offsetof(AbilitySystemComponent_ServerSetReplicatedTargetDataCancelled, ReplicatedTargetDataHandle) == 0x000020, "Member 'AbilitySystemComponent_ServerSetReplicatedTargetDataCancelled::ReplicatedTargetDataHandle' has a wrong offset!");
static_assert(offsetof(AbilitySystemComponent_ServerSetReplicatedTargetDataCancelled, ApplicationTag) == 0x000048, "Member 'AbilitySystemComponent_ServerSetReplicatedTargetDataCancelled::ApplicationTag' has a wrong offset!");
static_assert(offsetof(AbilitySystemComponent_ServerSetReplicatedTargetDataCancelled, CurrentPredictionKey) == 0x000050, "Member 'AbilitySystemComponent_ServerSetReplicatedTargetDataCancelled::CurrentPredictionKey' has a wrong offset!");
...
static_assert(sizeof(AbilitySystemComponent_SetActiveGameplayEffectLevelUsingQuery) == 0x0001B8, "Wrong size on AbilitySystemComponent_SetActiveGameplayEffectLevelUsingQuery");
...
static_assert(offsetof(AbilitySystemComponent_SetActiveGameplayEffectLevelUsingQuery, NewLevel) == 0x0001B0, "Member 'AbilitySystemComponent_SetActiveGameplayEffectLevelUsingQuery::NewLevel' has a wrong offset!");
...
static_assert(sizeof(AbilitySystemComponent_GetActiveEffects) == 0x0001C0, "Wrong size on AbilitySystemComponent_GetActiveEffects");
...
static_assert(offsetof(AbilitySystemComponent_GetActiveEffects, ReturnValue) == 0x0001B0, "Member 'AbilitySystemComponent_GetActiveEffects::ReturnValue' has a wrong offset!");
...
// Function GameplayAbilities.AbilitySystemComponent.GetAvatarActor
// 0x0008 (0x0008 - 0x0000)
struct AbilitySystemComponent_GetAvatarActor final
{
public:
	class AActor*                                 ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AbilitySystemComponent_GetAvatarActor) == 0x000008, "Wrong alignment on AbilitySystemComponent_GetAvatarActor");
static_assert(sizeof(AbilitySystemComponent_GetAvatarActor) == 0x000008, "Wrong size on AbilitySystemComponent_GetAvatarActor");
static_assert(offsetof(AbilitySystemComponent_GetAvatarActor, ReturnValue) == 0x000000, "Member 'AbilitySystemComponent_GetAvatarActor::ReturnValue' has a wrong offset!");

// Function GameplayAbilities.AbilitySystemComponent.GetCurrentMontageSectionName
// 0x0008 (0x0008 - 0x0000)
struct AbilitySystemComponent_GetCurrentMontageSectionName final
{
public:
	class FName                                   ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AbilitySystemComponent_GetCurrentMontageSectionName) == 0x000004, "Wrong alignment on AbilitySystemComponent_GetCurrentMontageSectionName");
static_assert(sizeof(AbilitySystemComponent_GetCurrentMontageSectionName) == 0x000008, "Wrong size on AbilitySystemComponent_GetCurrentMontageSectionName");
static_assert(offsetof(AbilitySystemComponent_GetCurrentMontageSectionName, ReturnValue) == 0x000000, "Member 'AbilitySystemComponent_GetCurrentMontageSectionName::ReturnValue' has a wrong offset!");
...
// Function GameplayAbilities.AbilitySystemComponent.GetOwnerActor
// 0x0008 (0x0008 - 0x0000)
struct AbilitySystemComponent_GetOwnerActor final
{
public:
	class AActor*                                 ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AbilitySystemComponent_GetOwnerActor) == 0x000008, "Wrong alignment on AbilitySystemComponent_GetOwnerActor");
static_assert(sizeof(AbilitySystemComponent_GetOwnerActor) == 0x000008, "Wrong size on AbilitySystemComponent_GetOwnerActor");
static_assert(offsetof(AbilitySystemComponent_GetOwnerActor, ReturnValue) == 0x000000, "Member 'AbilitySystemComponent_GetOwnerActor::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FGameplayEffectSpec                    Spec;                                              // 0x0008(0x02A8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	class UAbilitySystemComponent*                ASC;                                               // 0x02B0(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GameplayEffectCustomApplicationRequirement_CanApplyGameplayEffect) == 0x0002C0, "Wrong size on GameplayEffectCustomApplicationRequirement_CanApplyGameplayEffect");
...
static_assert(offsetof(GameplayEffectCustomApplicationRequirement_CanApplyGameplayEffect, ASC) == 0x0002B0, "Member 'GameplayEffectCustomApplicationRequirement_CanApplyGameplayEffect::ASC' has a wrong offset!");
static_assert(offsetof(GameplayEffectCustomApplicationRequirement_CanApplyGameplayEffect, ReturnValue) == 0x0002B8, "Member 'GameplayEffectCustomApplicationRequirement_CanApplyGameplayEffect::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GameplayModMagnitudeCalculation_CalculateBaseMagnitude) == 0x0002B0, "Wrong size on GameplayModMagnitudeCalculation_CalculateBaseMagnitude");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_CalculateBaseMagnitude, ReturnValue) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_CalculateBaseMagnitude::ReturnValue' has a wrong offset!");
...
public:
	...
	class FName                                   MagnitudeName;                                     // 0x02A8(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByName) == 0x0002B8, "Wrong size on GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByName");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByName, MagnitudeName) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByName::MagnitudeName' has a wrong offset!");
static_assert(offsetof(GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByName, ReturnValue) == 0x0002B0, "Member 'GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByName::ReturnValue' has a wrong offset!");
...
public:
	struct FGameplayEffectSpec                    EffectSpec;                                        // 0x0000(0x02A8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FGameplayTag                           Tag;                                               // 0x02A8(0x0008)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ReturnValue;                                       // 0x02B0(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B4[0x4];                                      // 0x02B4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByTag) == 0x0002B8, "Wrong size on GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByTag");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByTag, Tag) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByTag::Tag' has a wrong offset!");
static_assert(offsetof(GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByTag, ReturnValue) == 0x0002B0, "Member 'GameplayModMagnitudeCalculation_GetSetByCallerMagnitudeByTag::ReturnValue' has a wrong offset!");
...
public:
	struct FGameplayEffectSpec                    EffectSpec;                                        // 0x0000(0x02A8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  ReturnValue;                                       // 0x02A8(0x0020)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GameplayModMagnitudeCalculation_GetSourceActorTags) == 0x0002C8, "Wrong size on GameplayModMagnitudeCalculation_GetSourceActorTags");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_GetSourceActorTags, ReturnValue) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_GetSourceActorTags::ReturnValue' has a wrong offset!");
...
public:
	struct FGameplayEffectSpec                    EffectSpec;                                        // 0x0000(0x02A8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  ReturnValue;                                       // 0x02A8(0x0020)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GameplayModMagnitudeCalculation_GetSourceAggregatedTags) == 0x0002C8, "Wrong size on GameplayModMagnitudeCalculation_GetSourceAggregatedTags");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_GetSourceAggregatedTags, ReturnValue) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_GetSourceAggregatedTags::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GameplayModMagnitudeCalculation_GetSourceSpecTags) == 0x0002C8, "Wrong size on GameplayModMagnitudeCalculation_GetSourceSpecTags");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_GetSourceSpecTags, ReturnValue) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_GetSourceSpecTags::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GameplayModMagnitudeCalculation_GetTargetActorTags) == 0x0002C8, "Wrong size on GameplayModMagnitudeCalculation_GetTargetActorTags");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_GetTargetActorTags, ReturnValue) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_GetTargetActorTags::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GameplayModMagnitudeCalculation_GetTargetAggregatedTags) == 0x0002C8, "Wrong size on GameplayModMagnitudeCalculation_GetTargetAggregatedTags");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_GetTargetAggregatedTags, ReturnValue) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_GetTargetAggregatedTags::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GameplayModMagnitudeCalculation_GetTargetSpecTags) == 0x0002C8, "Wrong size on GameplayModMagnitudeCalculation_GetTargetSpecTags");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_GetTargetSpecTags, ReturnValue) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_GetTargetSpecTags::ReturnValue' has a wrong offset!");
...
public:
	struct FGameplayEffectSpec                    EffectSpec;                                        // 0x0000(0x02A8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FGameplayAttribute                     Attribute;                                         // 0x02A8(0x0038)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude) == 0x000328, "Wrong size on GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude");
...
static_assert(offsetof(GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude, Attribute) == 0x0002A8, "Member 'GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude::Attribute' has a wrong offset!");
static_assert(offsetof(GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude, SourceTags) == 0x0002E0, "Member 'GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude::SourceTags' has a wrong offset!");
static_assert(offsetof(GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude, TargetTags) == 0x000300, "Member 'GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude::TargetTags' has a wrong offset!");
static_assert(offsetof(GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude, ReturnValue) == 0x000320, "Member 'GameplayModMagnitudeCalculation_K2_GetCapturedAttributeMagnitude::ReturnValue' has a wrong offset!");
