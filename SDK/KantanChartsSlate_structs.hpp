...
// Enum KantanChartsSlate.EChartAxisDisplayType
// NumValues: 0x0004
enum class EChartAxisDisplayType : uint8
{
	Normal                                   = 0,
	ClockTime                                = 1,
	AbsoluteValue                            = 2,
	EChartAxisDisplayType_MAX                = 3,
};
...
public:
	...
	EChartAxisDisplayType                         ChartAxisDisplayType;                              // 0x0004(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCartesianAxisInstanceConfig) == 0x000001, "Wrong alignment on FCartesianAxisInstanceConfig");
static_assert(sizeof(FCartesianAxisInstanceConfig) == 0x000005, "Wrong size on FCartesianAxisInstanceConfig");
...
static_assert(offsetof(FCartesianAxisInstanceConfig, ChartAxisDisplayType) == 0x000004, "Member 'FCartesianAxisInstanceConfig::ChartAxisDisplayType' has a wrong offset!");
...
public:
	...
	struct FCartesianAxisInstanceConfig           LeftBottomAxis;                                    // 0x0038(0x0005)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FCartesianAxisInstanceConfig           RightTopAxis;                                      // 0x003D(0x0005)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FCartesianAxisInstanceConfig           FloatingAxis;                                      // 0x0042(0x0005)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FCartesianAxisConfig, RightTopAxis) == 0x00003D, "Member 'FCartesianAxisConfig::RightTopAxis' has a wrong offset!");
static_assert(offsetof(FCartesianAxisConfig, FloatingAxis) == 0x000042, "Member 'FCartesianAxisConfig::FloatingAxis' has a wrong offset!");
