...
public:
	...
	TArray<struct FGameplayEffectAttributeCaptureSpec> OriginalInstigatorAttributes;                 // 0x0020(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	bool                                          bHasNonSnapshottedAttributes;                      // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FGameplayEffectAttributeCaptureSpecContainer) == 0x000038, "Wrong size on FGameplayEffectAttributeCaptureSpecContainer");
...
static_assert(offsetof(FGameplayEffectAttributeCaptureSpecContainer, OriginalInstigatorAttributes) == 0x000020, "Member 'FGameplayEffectAttributeCaptureSpecContainer::OriginalInstigatorAttributes' has a wrong offset!");
static_assert(offsetof(FGameplayEffectAttributeCaptureSpecContainer, bHasNonSnapshottedAttributes) == 0x000030, "Member 'FGameplayEffectAttributeCaptureSpecContainer::bHasNonSnapshottedAttributes' has a wrong offset!");
...
public:
	...
	struct FGameplayEffectAttributeCaptureSpecContainer CapturedRelevantAttributes;                  // 0x0018(0x0038)(RepSkip, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x10];                                      // 0x0050(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Duration;                                          // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Period;                                            // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ChanceToApplyToTarget;                             // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTagContainerAggregator                CapturedSourceTags;                                // 0x0070(0x0088)(RepSkip, NativeAccessSpecifierPublic)
	struct FTagContainerAggregator                CapturedTargetTags;                                // 0x00F8(0x0088)(RepSkip, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  DynamicGrantedTags;                                // 0x0180(0x0020)(NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  DynamicAssetTags;                                  // 0x01A0(0x0020)(NativeAccessSpecifierPublic)
	TArray<struct FModifierSpec>                  Modifiers;                                         // 0x01C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         StackCount;                                        // 0x01D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bCompletedSourceAttributeCapture : 1;              // 0x01D4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCompletedTargetAttributeCapture : 1;              // 0x01D4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCompletedOriginalInstigatorAttributeCapture : 1;  // 0x01D4(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDurationLocked : 1;                               // 0x01D4(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1D5[0x3];                                      // 0x01D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGameplayAbilitySpecDef>        GrantedAbilitySpecs;                               // 0x01D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E8[0xA0];                                     // 0x01E8(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayEffectContextHandle           EffectContext;                                     // 0x0288(0x0018)(NativeAccessSpecifierPrivate)
	float                                         Level;                                             // 0x02A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FGameplayEffectSpec) == 0x0002A8, "Wrong size on FGameplayEffectSpec");
...
static_assert(offsetof(FGameplayEffectSpec, Duration) == 0x000060, "Member 'FGameplayEffectSpec::Duration' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, Period) == 0x000064, "Member 'FGameplayEffectSpec::Period' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, ChanceToApplyToTarget) == 0x000068, "Member 'FGameplayEffectSpec::ChanceToApplyToTarget' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, CapturedSourceTags) == 0x000070, "Member 'FGameplayEffectSpec::CapturedSourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, CapturedTargetTags) == 0x0000F8, "Member 'FGameplayEffectSpec::CapturedTargetTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, DynamicGrantedTags) == 0x000180, "Member 'FGameplayEffectSpec::DynamicGrantedTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, DynamicAssetTags) == 0x0001A0, "Member 'FGameplayEffectSpec::DynamicAssetTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, Modifiers) == 0x0001C0, "Member 'FGameplayEffectSpec::Modifiers' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, StackCount) == 0x0001D0, "Member 'FGameplayEffectSpec::StackCount' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, GrantedAbilitySpecs) == 0x0001D8, "Member 'FGameplayEffectSpec::GrantedAbilitySpecs' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, EffectContext) == 0x000288, "Member 'FGameplayEffectSpec::EffectContext' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpec, Level) == 0x0002A0, "Member 'FGameplayEffectSpec::Level' has a wrong offset!");
...
public:
	...
	struct FGameplayEffectSpec                    Spec;                                              // 0x0018(0x02A8)(NativeAccessSpecifierPublic)
	struct FPredictionKey                         PredictionKey;                                     // 0x02C0(0x0018)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FGameplayAbilitySpecHandle>     GrantedAbilityHandles;                             // 0x02D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         StartServerWorldTime;                              // 0x02E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CachedStartServerWorldTime;                        // 0x02EC(0x0004)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StartWorldTime;                                    // 0x02F0(0x0004)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsInhibited;                                      // 0x02F4(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F5[0x83];                                     // 0x02F5(0x0083)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagRequirements               DynamicOngoingTagRequirements;                     // 0x0378(0x0088)(NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FActiveGameplayEffect, PredictionKey) == 0x0002C0, "Member 'FActiveGameplayEffect::PredictionKey' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, GrantedAbilityHandles) == 0x0002D8, "Member 'FActiveGameplayEffect::GrantedAbilityHandles' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, StartServerWorldTime) == 0x0002E8, "Member 'FActiveGameplayEffect::StartServerWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, CachedStartServerWorldTime) == 0x0002EC, "Member 'FActiveGameplayEffect::CachedStartServerWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, StartWorldTime) == 0x0002F0, "Member 'FActiveGameplayEffect::StartWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, bIsInhibited) == 0x0002F4, "Member 'FActiveGameplayEffect::bIsInhibited' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, DynamicOngoingTagRequirements) == 0x000378, "Member 'FActiveGameplayEffect::DynamicOngoingTagRequirements' has a wrong offset!");
...
public:
	...
	float                                         HitNormalOffsetMultiplier;                         // 0x000C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOrientInDirectionOfHitNormal;                     // 0x0010(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOrientInDirectionOfHit;                           // 0x0011(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTrySpawnAtHitLocation;                            // 0x0012(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideSpawnZWithTraceZ;                         // 0x0013(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShiftSpawnXYToCollisionBorder;                    // 0x0014(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bOverrideRotation : 1;                             // 0x0018(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideScale : 1;                                // 0x0018(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               RotationOverride;                                  // 0x0020(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                ScaleOverride;                                     // 0x0038(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayCueNotify_PlacementInfo) == 0x000008, "Wrong alignment on FGameplayCueNotify_PlacementInfo");
static_assert(sizeof(FGameplayCueNotify_PlacementInfo) == 0x000050, "Wrong size on FGameplayCueNotify_PlacementInfo");
...
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, HitNormalOffsetMultiplier) == 0x00000C, "Member 'FGameplayCueNotify_PlacementInfo::HitNormalOffsetMultiplier' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, bOrientInDirectionOfHitNormal) == 0x000010, "Member 'FGameplayCueNotify_PlacementInfo::bOrientInDirectionOfHitNormal' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, bOrientInDirectionOfHit) == 0x000011, "Member 'FGameplayCueNotify_PlacementInfo::bOrientInDirectionOfHit' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, bTrySpawnAtHitLocation) == 0x000012, "Member 'FGameplayCueNotify_PlacementInfo::bTrySpawnAtHitLocation' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, bOverrideSpawnZWithTraceZ) == 0x000013, "Member 'FGameplayCueNotify_PlacementInfo::bOverrideSpawnZWithTraceZ' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, bShiftSpawnXYToCollisionBorder) == 0x000014, "Member 'FGameplayCueNotify_PlacementInfo::bShiftSpawnXYToCollisionBorder' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, RotationOverride) == 0x000020, "Member 'FGameplayCueNotify_PlacementInfo::RotationOverride' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, ScaleOverride) == 0x000038, "Member 'FGameplayCueNotify_PlacementInfo::ScaleOverride' has a wrong offset!");
...
public:
	...
	struct FGameplayCueNotify_PlacementInfo       PlacementInfoOverride;                             // 0x0038(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     DecalMaterial;                                     // 0x0088(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SkinningKeyword;                                   // 0x0090(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DecalSize;                                         // 0x0098(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOverrideSpawnCondition : 1;                       // 0x00B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverridePlacementInfo : 1;                        // 0x00B0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideFadeOut : 1;                              // 0x00B0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_B1[0x3];                                       // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         FadeOutStartDelay;                                 // 0x00B4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayCueNotify_DecalInfo) == 0x0000C0, "Wrong size on FGameplayCueNotify_DecalInfo");
...
static_assert(offsetof(FGameplayCueNotify_DecalInfo, DecalMaterial) == 0x000088, "Member 'FGameplayCueNotify_DecalInfo::DecalMaterial' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, SkinningKeyword) == 0x000090, "Member 'FGameplayCueNotify_DecalInfo::SkinningKeyword' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, DecalSize) == 0x000098, "Member 'FGameplayCueNotify_DecalInfo::DecalSize' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, FadeOutStartDelay) == 0x0000B4, "Member 'FGameplayCueNotify_DecalInfo::FadeOutStartDelay' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, FadeOutDuration) == 0x0000B8, "Member 'FGameplayCueNotify_DecalInfo::FadeOutDuration' has a wrong offset!");
...
public:
	...
	uint8                                         GameplayStackCount;                                // 0x00C8(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C9[0x3];                                       // 0x00C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class USceneComponent>         TargetAttachComponent;                             // 0x00CC(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bReplicateLocationWhenUsingMinimalRepProxy;        // 0x00D4(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayCueParameters, GameplayStackCount) == 0x0000C8, "Member 'FGameplayCueParameters::GameplayStackCount' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, TargetAttachComponent) == 0x0000CC, "Member 'FGameplayCueParameters::TargetAttachComponent' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, bReplicateLocationWhenUsingMinimalRepProxy) == 0x0000D4, "Member 'FGameplayCueParameters::bReplicateLocationWhenUsingMinimalRepProxy' has a wrong offset!");
...
public:
	...
	TWeakObjectPtr<class AActor>                  Instigator;                                        // 0x0008(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class AActor>                  Target;                                            // 0x0010(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UObject>                 OptionalObject;                                    // 0x0018(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UObject>                 OptionalObject2;                                   // 0x0020(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TDelegate<void(const struct FActiveGameplayEffect& Effect, bool* bMatches)> CustomMatchDelegate_BP; // 0x0020(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UObject*                                EffectSource;                                      // 0x0188(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSubclassOf<class UGameplayAbility>           AbilitySource;                                     // 0x01A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayEffectQuery) == 0x000008, "Wrong alignment on FGameplayEffectQuery");
static_assert(sizeof(FGameplayEffectQuery) == 0x0001B0, "Wrong size on FGameplayEffectQuery");
static_assert(offsetof(FGameplayEffectQuery, CustomMatchDelegate_BP) == 0x000020, "Member 'FGameplayEffectQuery::CustomMatchDelegate_BP' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, OwningTagQuery) == 0x000030, "Member 'FGameplayEffectQuery::OwningTagQuery' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, EffectTagQuery) == 0x000078, "Member 'FGameplayEffectQuery::EffectTagQuery' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, SourceTagQuery) == 0x0000C0, "Member 'FGameplayEffectQuery::SourceTagQuery' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, SourceAggregateTagQuery) == 0x000108, "Member 'FGameplayEffectQuery::SourceAggregateTagQuery' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, ModifyingAttribute) == 0x000150, "Member 'FGameplayEffectQuery::ModifyingAttribute' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, EffectSource) == 0x000188, "Member 'FGameplayEffectQuery::EffectSource' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, EffectDefinition) == 0x000190, "Member 'FGameplayEffectQuery::EffectDefinition' has a wrong offset!");
static_assert(offsetof(FGameplayEffectQuery, AbilitySource) == 0x0001A8, "Member 'FGameplayEffectQuery::AbilitySource' has a wrong offset!");
...
public:
	...
	uint8                                         GameplayStackCount;                                // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayEffectSpecForRPC, GameplayStackCount) == 0x000078, "Member 'FGameplayEffectSpecForRPC::GameplayStackCount' has a wrong offset!");
...
public:
	...
	struct FGameplayCueParameters                 CueParameters;                                     // 0x00C0(0x00D8)(ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
public:
	...
	int32                                         MontageInstanceID;                                 // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayAbilityLocalAnimMontage, MontageInstanceID) == 0x000030, "Member 'FGameplayAbilityLocalAnimMontage::MontageInstanceID' has a wrong offset!");
...
public:
	struct FGameplayCueNotify_SpawnCondition      SpawnConditionOverride;                            // 0x0000(0x0038)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_PlacementInfo       PlacementInfoOverride;                             // 0x0038(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	class USoundBase*                             Sound;                                             // 0x0088(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundBase*                             SoundCue;                                          // 0x0090(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SkinningKeyword;                                   // 0x0098(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LoopingFadeOutDuration;                            // 0x00A0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LoopingFadeVolumeLevel;                            // 0x00A4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_SoundParameterInterfaceInfo SoundParameterInterfaceInfo;               // 0x00A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bOverrideSpawnCondition : 1;                       // 0x00B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverridePlacementInfo : 1;                        // 0x00B0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseSoundParameterInterface : 1;                   // 0x00B0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FGameplayCueNotify_SoundInfo) == 0x0000B8, "Wrong size on FGameplayCueNotify_SoundInfo");
...
static_assert(offsetof(FGameplayCueNotify_SoundInfo, Sound) == 0x000088, "Member 'FGameplayCueNotify_SoundInfo::Sound' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, SoundCue) == 0x000090, "Member 'FGameplayCueNotify_SoundInfo::SoundCue' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, SkinningKeyword) == 0x000098, "Member 'FGameplayCueNotify_SoundInfo::SkinningKeyword' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, LoopingFadeOutDuration) == 0x0000A0, "Member 'FGameplayCueNotify_SoundInfo::LoopingFadeOutDuration' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, LoopingFadeVolumeLevel) == 0x0000A4, "Member 'FGameplayCueNotify_SoundInfo::LoopingFadeVolumeLevel' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, SoundParameterInterfaceInfo) == 0x0000A8, "Member 'FGameplayCueNotify_SoundInfo::SoundParameterInterfaceInfo' has a wrong offset!");
...
public:
	...
	class UObjectLibrary*                         ActorObjectLibrary;                                // 0x0040(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObjectLibrary*                         StaticObjectLibrary;                               // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGameplayCueSet*                        CueSet;                                            // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayCueObjectLibrary) == 0x000060, "Wrong size on FGameplayCueObjectLibrary");
...
static_assert(offsetof(FGameplayCueObjectLibrary, ActorObjectLibrary) == 0x000040, "Member 'FGameplayCueObjectLibrary::ActorObjectLibrary' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, StaticObjectLibrary) == 0x000048, "Member 'FGameplayCueObjectLibrary::StaticObjectLibrary' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, CueSet) == 0x000050, "Member 'FGameplayCueObjectLibrary::CueSet' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, bShouldSyncScan) == 0x00005C, "Member 'FGameplayCueObjectLibrary::bShouldSyncScan' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, bShouldAsyncLoad) == 0x00005D, "Member 'FGameplayCueObjectLibrary::bShouldAsyncLoad' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, bShouldSyncLoad) == 0x00005E, "Member 'FGameplayCueObjectLibrary::bShouldSyncLoad' has a wrong offset!");
static_assert(offsetof(FGameplayCueObjectLibrary, bHasBeenInitialized) == 0x00005F, "Member 'FGameplayCueObjectLibrary::bHasBeenInitialized' has a wrong offset!");
...
public:
	struct FGameplayCueNotify_SpawnCondition      SpawnConditionOverride;                            // 0x0000(0x0038)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_PlacementInfo       PlacementInfoOverride;                             // 0x0038(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         NiagaraSystem;                                     // 0x0088(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SkinningKeyword;                                   // 0x0090(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bCastShadow : 1;                                   // 0x0098(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FGameplayCueNotify_ParticleInfo) == 0x0000A0, "Wrong size on FGameplayCueNotify_ParticleInfo");
...
static_assert(offsetof(FGameplayCueNotify_ParticleInfo, NiagaraSystem) == 0x000088, "Member 'FGameplayCueNotify_ParticleInfo::NiagaraSystem' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ParticleInfo, SkinningKeyword) == 0x000090, "Member 'FGameplayCueNotify_ParticleInfo::SkinningKeyword' has a wrong offset!");
...
public:
	...
	EGameplayCueNotify_EffectPlaySpace            PlaySpace;                                         // 0x0094(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayCueNotify_CameraShakeInfo) == 0x0000A8, "Wrong size on FGameplayCueNotify_CameraShakeInfo");
...
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, CameraShake) == 0x000088, "Member 'FGameplayCueNotify_CameraShakeInfo::CameraShake' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, ShakeScale) == 0x000090, "Member 'FGameplayCueNotify_CameraShakeInfo::ShakeScale' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, PlaySpace) == 0x000094, "Member 'FGameplayCueNotify_CameraShakeInfo::PlaySpace' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldInnerRadius) == 0x00009C, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldInnerRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldOuterRadius) == 0x0000A0, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldOuterRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldFalloffExponent) == 0x0000A4, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldFalloffExponent' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_CameraLensEffectInfo) == 0x0000A0, "Wrong size on FGameplayCueNotify_CameraLensEffectInfo");
...
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, CameraLensEffect) == 0x000088, "Member 'FGameplayCueNotify_CameraLensEffectInfo::CameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, WorldInnerRadius) == 0x000094, "Member 'FGameplayCueNotify_CameraLensEffectInfo::WorldInnerRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, WorldOuterRadius) == 0x000098, "Member 'FGameplayCueNotify_CameraLensEffectInfo::WorldOuterRadius' has a wrong offset!");
...
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, ForceFeedbackEffect) == 0x000088, "Member 'FGameplayCueNotify_ForceFeedbackInfo::ForceFeedbackEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, ForceFeedbackTag) == 0x000090, "Member 'FGameplayCueNotify_ForceFeedbackInfo::ForceFeedbackTag' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, WorldIntensity) == 0x00009C, "Member 'FGameplayCueNotify_ForceFeedbackInfo::WorldIntensity' has a wrong offset!");
...
{
public:
	TArray<struct FGameplayCueNotify_ParticleInfo> BurstParticles;                                   // 0x0000(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<struct FGameplayCueNotify_SoundInfo>   BurstSounds;                                       // 0x0010(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_CameraShakeInfo     BurstCameraShake;                                  // 0x0020(0x00A8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_CameraLensEffectInfo BurstCameraLensEffect;                            // 0x00C8(0x00A0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_ForceFeedbackInfo   BurstForceFeedback;                                // 0x0168(0x00A8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_InputDevicePropertyInfo BurstDevicePropertyEffect;                     // 0x0210(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_DecalInfo           BurstDecal;                                        // 0x0220(0x00C0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstCameraLensEffect) == 0x0000C8, "Member 'FGameplayCueNotify_BurstEffects::BurstCameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstForceFeedback) == 0x000168, "Member 'FGameplayCueNotify_BurstEffects::BurstForceFeedback' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstDevicePropertyEffect) == 0x000210, "Member 'FGameplayCueNotify_BurstEffects::BurstDevicePropertyEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstDecal) == 0x000220, "Member 'FGameplayCueNotify_BurstEffects::BurstDecal' has a wrong offset!");
...
{
public:
	TArray<struct FGameplayCueNotify_ParticleInfo> LoopingParticles;                                 // 0x0000(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<struct FGameplayCueNotify_SoundInfo>   LoopingSounds;                                     // 0x0010(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_CameraShakeInfo     LoopingCameraShake;                                // 0x0020(0x00A8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_CameraLensEffectInfo LoopingCameraLensEffect;                          // 0x00C8(0x00A0)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_ForceFeedbackInfo   LoopingForceFeedback;                              // 0x0168(0x00A8)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayCueNotify_InputDevicePropertyInfo LoopingInputDevicePropertyEffect;              // 0x0210(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayCueNotify_LoopingEffects) == 0x000008, "Wrong alignment on FGameplayCueNotify_LoopingEffects");
static_assert(sizeof(FGameplayCueNotify_LoopingEffects) == 0x000220, "Wrong size on FGameplayCueNotify_LoopingEffects");
...
static_assert(offsetof(FGameplayCueNotify_LoopingEffects, LoopingCameraLensEffect) == 0x0000C8, "Member 'FGameplayCueNotify_LoopingEffects::LoopingCameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_LoopingEffects, LoopingForceFeedback) == 0x000168, "Member 'FGameplayCueNotify_LoopingEffects::LoopingForceFeedback' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_LoopingEffects, LoopingInputDevicePropertyEffect) == 0x000210, "Member 'FGameplayCueNotify_LoopingEffects::LoopingInputDevicePropertyEffect' has a wrong offset!");
