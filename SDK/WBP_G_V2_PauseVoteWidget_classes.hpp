...
// WidgetBlueprintGeneratedClass WBP_G_V2_PauseVoteWidget.WBP_G_V2_PauseVoteWidget_C
// 0x0088 (0x0700 - 0x0678)
class UWBP_G_V2_PauseVoteWidget_C final : public UHWPauseVoteWidget
{
public:
	...
	class USoundBase*                             SFXPauseVotePopup;                                 // 0x06F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void ExecuteUbergraph_WBP_G_V2_PauseVoteWidget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_G_V2_PauseVoteWidget_C">();
	}
	static class UWBP_G_V2_PauseVoteWidget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_G_V2_PauseVoteWidget_C>();
	}
};
static_assert(alignof(UWBP_G_V2_PauseVoteWidget_C) == 0x000008, "Wrong alignment on UWBP_G_V2_PauseVoteWidget_C");
static_assert(sizeof(UWBP_G_V2_PauseVoteWidget_C) == 0x000700, "Wrong size on UWBP_G_V2_PauseVoteWidget_C");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, UberGraphFrame) == 0x000678, "Member 'UWBP_G_V2_PauseVoteWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, ButtonSwitcher) == 0x000680, "Member 'UWBP_G_V2_PauseVoteWidget_C::ButtonSwitcher' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, HWImage_156) == 0x000688, "Member 'UWBP_G_V2_PauseVoteWidget_C::HWImage_156' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, HWImage_556) == 0x000690, "Member 'UWBP_G_V2_PauseVoteWidget_C::HWImage_556' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, NoPrompt) == 0x000698, "Member 'UWBP_G_V2_PauseVoteWidget_C::NoPrompt' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, PipContainer) == 0x0006A0, "Member 'UWBP_G_V2_PauseVoteWidget_C::PipContainer' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, ResultText) == 0x0006A8, "Member 'UWBP_G_V2_PauseVoteWidget_C::ResultText' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, TimerBar) == 0x0006B0, "Member 'UWBP_G_V2_PauseVoteWidget_C::TimerBar' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, TimerGroup) == 0x0006B8, "Member 'UWBP_G_V2_PauseVoteWidget_C::TimerGroup' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, TimerText) == 0x0006C0, "Member 'UWBP_G_V2_PauseVoteWidget_C::TimerText' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, TopDeco) == 0x0006C8, "Member 'UWBP_G_V2_PauseVoteWidget_C::TopDeco' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, YesPrompt) == 0x0006D0, "Member 'UWBP_G_V2_PauseVoteWidget_C::YesPrompt' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, bResolved) == 0x0006D8, "Member 'UWBP_G_V2_PauseVoteWidget_C::bResolved' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, PipPadding) == 0x0006DC, "Member 'UWBP_G_V2_PauseVoteWidget_C::PipPadding' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, SFXPauseVotePopup) == 0x0006F0, "Member 'UWBP_G_V2_PauseVoteWidget_C::SFXPauseVotePopup' has a wrong offset!");
static_assert(offsetof(UWBP_G_V2_PauseVoteWidget_C, SFXSelect) == 0x0006F8, "Member 'UWBP_G_V2_PauseVoteWidget_C::SFXSelect' has a wrong offset!");
