...
public:
	...
	class UMaterialInstanceConstant*              ConstantCreatedMaterial;                           // 0x00D0(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInstanceDynamic*               DynamicCreatedMaterial;                            // 0x00D8(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<int32, struct FGuid>                     OutputTextureLinkData;                             // 0x00E0(0x0050)(NativeAccessSpecifierPublic)
	TMap<uint32, class USubstanceOutputData*>     OutputInstances;                                   // 0x0130(0x0050)(NativeAccessSpecifierPublic)
	bool                                          bIsFrozen;                                         // 0x0180(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USubstanceGraphInstance) == 0x0001A0, "Wrong size on USubstanceGraphInstance");
...
static_assert(offsetof(USubstanceGraphInstance, ConstantCreatedMaterial) == 0x0000D0, "Member 'USubstanceGraphInstance::ConstantCreatedMaterial' has a wrong offset!");
static_assert(offsetof(USubstanceGraphInstance, DynamicCreatedMaterial) == 0x0000D8, "Member 'USubstanceGraphInstance::DynamicCreatedMaterial' has a wrong offset!");
static_assert(offsetof(USubstanceGraphInstance, OutputTextureLinkData) == 0x0000E0, "Member 'USubstanceGraphInstance::OutputTextureLinkData' has a wrong offset!");
static_assert(offsetof(USubstanceGraphInstance, OutputInstances) == 0x000130, "Member 'USubstanceGraphInstance::OutputInstances' has a wrong offset!");
static_assert(offsetof(USubstanceGraphInstance, bIsFrozen) == 0x000180, "Member 'USubstanceGraphInstance::bIsFrozen' has a wrong offset!");
...
public:
	...
	class USubstanceGraphInstance*                ParentInstance;                                    // 0x0210(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextureAddress                               AddressX;                                          // 0x0218(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextureAddress                               AddressY;                                          // 0x0219(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCooked;                                           // 0x021A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21B[0x25];                                     // 0x021B(0x0025)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USubstanceTexture2D) == 0x000240, "Wrong size on USubstanceTexture2D");
static_assert(offsetof(USubstanceTexture2D, ParentInstance) == 0x000210, "Member 'USubstanceTexture2D::ParentInstance' has a wrong offset!");
static_assert(offsetof(USubstanceTexture2D, AddressX) == 0x000218, "Member 'USubstanceTexture2D::AddressX' has a wrong offset!");
static_assert(offsetof(USubstanceTexture2D, AddressY) == 0x000219, "Member 'USubstanceTexture2D::AddressY' has a wrong offset!");
static_assert(offsetof(USubstanceTexture2D, bCooked) == 0x00021A, "Member 'USubstanceTexture2D::bCooked' has a wrong offset!");
