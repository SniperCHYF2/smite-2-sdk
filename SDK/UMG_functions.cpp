...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// EConsumeAnalog                          NewConsumeAnalog                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UScrollBox::SetConsumeAnalog(EConsumeAnalog NewConsumeAnalog)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ScrollBox", "SetConsumeAnalog");

	Params::ScrollBox_SetConsumeAnalog Parms{};

	Parms.NewConsumeAnalog = NewConsumeAnalog;
