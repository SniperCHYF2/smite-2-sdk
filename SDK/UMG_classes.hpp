...
public:
	...
	TMulticastInlineDelegate<void()>              OnRightClicked;                                    // 0x05C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnPressed;                                         // 0x05D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnReleased;                                        // 0x05E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnHovered;                                         // 0x05F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnUnhovered;                                       // 0x0608(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UButton) == 0x000630, "Wrong size on UButton");
...
static_assert(offsetof(UButton, OnRightClicked) == 0x0005C8, "Member 'UButton::OnRightClicked' has a wrong offset!");
static_assert(offsetof(UButton, OnPressed) == 0x0005D8, "Member 'UButton::OnPressed' has a wrong offset!");
static_assert(offsetof(UButton, OnReleased) == 0x0005E8, "Member 'UButton::OnReleased' has a wrong offset!");
static_assert(offsetof(UButton, OnHovered) == 0x0005F8, "Member 'UButton::OnHovered' has a wrong offset!");
static_assert(offsetof(UButton, OnUnhovered) == 0x000608, "Member 'UButton::OnUnhovered' has a wrong offset!");
...
public:
	...
	EConsumeAnalog                                ConsumeAnalog;                                     // 0x0C83(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	void SetConsumeAnalog(EConsumeAnalog NewConsumeAnalog);
...
static_assert(offsetof(UScrollBox, ConsumeAnalog) == 0x000C83, "Member 'UScrollBox::ConsumeAnalog' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_CA0[0x28];                                     // 0x0CA0(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
